...
class {%= safe_name %} {
	 ...
	 * @since    {%= version %}
	 * @access   protected
	 * @var      string    ${%= safe_name %}    The string used to uniquely identify this plugin.
	 */
	protected ${%= safe_name %};
	 ...
	 * - {%= safe_name %}_Admin. Defines all hooks for the admin area.
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new {%= safe_name %}_Admin( $this->get_{%= safe_name %}(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new {%= safe_name %}_Public( $this->get_{%= safe_name %}(), $this->get_version() );
	 ...
	 */
	public function get_{%= safe_name %}() {
